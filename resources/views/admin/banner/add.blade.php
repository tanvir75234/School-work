...
@section('content')
                    <div class="row">
                        <div class="col-md-12 ">
                            <form action="{{ url('/dashboard/banner/submit') }}" method="post" >
                              @csrf
                                <div class="card mb-3">
                                  <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 card_button_part">
                                            <a href="all-user.html" class="btn btn-sm btn-dark"><i class="fas fa-th"></i>All Banner</a>
                                        </div>  
                                    </div>
                                  </div>
                                  <div class="card-body">
                                  <div class="row">
                                      ...
                                      <div class="row mb-3">
                                        ...
                                        <div class="col-sm-7">
                                          <input type="file" class="form-control form_control" id="" name="banner_images">
                                        </div>
                                          </div>   
