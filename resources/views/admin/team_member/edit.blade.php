...
@section('content')
        <div class="row">
            <div class="col-md-12 ">
                <form action="{{ url('/dashboard/team/update') }}" method="post" >
                  @csrf
                    <div class="card mb-3">
                      ...
                      <div class="row">
                              ...
                              <div class="row">
                                <div class="col-md-6 mb-2">
                                  <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" id="" name="member_facebook" value="{{old('member_facebook')}}">
                                  </div>
                                </div>
                                <div class="col-md-6 mb-2">
                                  <div class="input-group">
                                      <div class="input-group-text"><i class="fab fa-twitter fa-lg"></i></div>
                                      <input type="text" class="form-control" id="" name="member_twitter" value="{{old('member_twitter')}}">
                                  </div>
                                </div>
                                <div class="col-md-6">
                                  <div class="input-group">
                                      <div class="input-group-text"><i class="fab fa-whatsapp-square fa-lg"></i></div>
                                      <input type="text" class="form-control" id="" name="member_whatsapp" value="{{old('member_whatsapp')}}">
                                  </div>
                                </div>
                                <div class="col-md-6">
                                  <div class="input-group">
                                      <div class="input-group-text"><i class="fab fa-instagram fa-lg"></i></div>
                                      <input type="text" class="form-control" id="" name="member_instagram" value="{{old('member_instagram')}}">
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-sm-7">
                              <input type="text" class="form-control form_control" id="" name="member_order" value="{{ $team->member_order }}">
                            </div>
                          </div>
                          <div class="row mb-3">
                            <label class="col-sm-3 col-form-label col_form_label">Photo<span class="req_star">*</span>:</label>
                            <div class="col-sm-7">
                              <input type="text" class="form-control form_control" id="" name="member_photo" value="{{ $team->member_photo }}">
                            </div>
                          </div>
                        </div>   
