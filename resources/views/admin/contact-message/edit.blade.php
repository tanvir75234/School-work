...
@section('content')
                    <div class="row">
                        <div class="col-md-12 ">
                            <form action="{{ url('/dashboard/contact/message/update') }}" method="post" >
                              @csrf
                                <div class="card mb-3">
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="row mb-3">
                                        ...
                                        <div class="col-sm-7">
                                          <input type="text" class="form-control form_control" id="" name="cm_message" value="{{ $contact->cm_message }}">
                                        </div>
                                          </div>   
