                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-sm btn-dark dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">Manage</button>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ url('/dashboard/project/view/'.$data->project_slug) }}">View</a></li>
                                    <li><a class="dropdown-item" href="{{ url('/dashboard/project/edit/'.$data->project_slug) }}">Edit</a></li>
...
<div class="modal fade" id="softDeleteModal" tabindex="-1" aria-labelledby="softDeleteModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <form action="{{ route('project.softdelete') }}" method="post">
        @csrf
