...
@section('website')
  ...
  @php 
    $banner=App\Models\Banner::where('banner_status',1)->orderBy('banner_id','DESC')->firstOrFail();
  @endphp
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('{{ asset('website') }}/images/bg_1.jpg')">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              <h2 class="mb-0">{{$banner->banner_title}}</h2>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-lg-6 mb-lg-0 mb-4">
                    <img src="{{ asset('website') }}/images/course_4.jpg" alt="Image" class="img-fluid"> 
                </div>
