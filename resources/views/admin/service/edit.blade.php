                                  ...
                                  <div class="row">
                                      ...
                                      <div class="row mb-3">
                                        ...
                                        <div class="col-sm-7">
                                          ...
                                          <input type="text" class="form-control form_control" id="" name="service_title" value="{{ $service->service_title }}">
                                        </div>
                                      </div>
                                      <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label col_form_label">Subtitile:</label>
                                        <div class="col-sm-7">
                                          <input type="text" class="form-control form_control" id="" name="service_subtitle" value="{{ $service->service_subtitle }}">
                                        </div>
                                      </div>
                                      <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label col_form_label">Details<span class="req_star">*</span>:</label>
                                        <div class="col-sm-7">
                                          <input type="summernote" class="form-control form_control" id="" name="service_details" value="{{ $service->service_details }}">
                                        </div>
                                      </div>
                                      <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label col_form_label">Order<span class="req_star">*</span>:</label>
                                        <div class="col-sm-7">
                                          <input type="text" class="form-control form_control" id="" name="service_order" value="{{ $service->service_order }}">
                                        </div>
                                      </div>
                                      <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label col_form_label">Icon<span class="req_star">*</span>:</label>
                                        <div class="col-sm-7">
                                          <input type="file" class="form-control form_control" id="" name="service_icon" value="{{ $service->service_icon }}">
                                        </div>
                                          </div>   
