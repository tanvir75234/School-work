...
@section('content')
                    <div class="row">
                        <div class="col-md-12 ">
                            <form action="{{ url('/dashboard/client/update') }}" method="post" >
                              @csrf
                                <div class="card mb-3">
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="row mb-3">
                                        ...
                                        <div class="col-sm-7">
                                          <input type="summernote" class="form-control form_control" id="" name="client_order" value="{{ $client->client_order }}">
                                        </div>
                                      </div>
                                      <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label col_form_label">Logo<span class="req_star">*</span>:</label>
                                        <div class="col-sm-7">
                                          <input type="file" class="form-control form_control" id="" name="client_logo" value="{{ $client->client_logo }}">
                                        </div>
                                          </div>   
